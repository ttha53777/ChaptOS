...
// ─── Category color dot helper ────────────────────────────────────────────────

function catColor(name: string, index: number): string {
                  ...
                  {filteredRunningData.length === 0 ? (
                    ...
                    <>
                      ...
                      <ResponsiveContainer width="100%" height={180}>
                        <AreaChart data={filteredRunningData} margin={{ top: 8, right: 8, bottom: 0, left: -16 }}>
                          <defs>
