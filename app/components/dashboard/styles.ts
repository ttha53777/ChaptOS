...
// Badge styling for the new Task model: a "done" task shows a single Done badge;
// an open task shows its COMPUTED urgency. Keyed by `${status}:${urgency}` resolved
// in TaskUrgencyBadge.
export const TASK_URGENCY_STYLES: Record<string, { label: string; cls: string }> = {
